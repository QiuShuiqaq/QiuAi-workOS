...
export const serverToolActions: ServerToolActionDefinition[] = [
  ...
  },
  {
    ...
    input: [
      ...
      { key: 'segmentAudioPaths', label: '分段口播音频路径列表', type: 'json' },
      { key: 'musicPath', label: '背景音乐路径', type: 'file' },
      ...
      { key: 'transitionEffect', label: '过场效果', type: 'text' },
    ...
    uiFields: [
      ...
      { key: 'segmentAudioPaths', label: '分段口播音频路径列表 JSON', type: 'textarea', format: 'json' },
      { key: 'musicPath', label: '背景音乐路径' },
      { key: 'coverPath', label: 'Cover PNG path' },
      { key: 'introPath', label: 'Intro MP4 path' },
      { key: 'outroPath', label: 'Outro MP4 path' },
      { key: 'transitionEffect', label: '过场效果' },
