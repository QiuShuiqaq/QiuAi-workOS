...
const modelAssets: ServerAssetDefinitionSeed[] = [
  ...
  model(2460, 'qiu-asr-default', '默认语音转文字模型', 'aliyun-bailian', 'qwen3-asr-flash', ['audio'], ['text', 'json'], ['audio_to_text'], ['本地抽音频转写', '方言识别', '音频质检'], { availabilityStatus: 'provider_documented', apiStyle: 'provider_native', modelProfileId: 'qiu-asr-default' }),
